...
fig2.suptitle(f'Galileo MAG for {title_label} on {flyby_date_str}', fontsize = 20)
...
axs2[0].set_xlabel('X ($R_Moon$)', fontsize = 20)
axs2[0].set_ylabel('Y ($R_Moon$)', fontsize = 20)
...
axs2[1].set_xlabel('Y ($R_Moon$)', fontsize = 20)
axs2[1].set_ylabel('Z ($R_Moon$)', fontsize = 20)
moon_circle = Circle((0, 0), 1, color='black', fill=False, linewidth=2, label='Europa')  # Create a new moon circle for this plot
